...
- If there are no previous reviews in `<ralph>/<run>/logs` (i.e. `review-*.md`) then review the plan for accuracy and completness
- Otherwise, your job is to review the work being done to accomplish the plan.
    - Follow the guidelines in https://raw.githubusercontent.com/openai/codex/refs/heads/main/codex-rs/core/review_prompt.md
